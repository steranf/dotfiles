...
**Linux / WSL2:**
```bash
curl -fsSL https://raw.githubusercontent.com/steranf/dotfiles/v1.0.5/bootstrap.sh | bash
```

**Windows — PowerShell como Administrador:**
```powershell
irm https://raw.githubusercontent.com/steranf/dotfiles/v1.0.5/bootstrap.ps1 | iex
```
...
> ```bash
> curl -fsSL https://raw.githubusercontent.com/steranf/dotfiles/v1.0.5/bootstrap.sh | bash -s -- --all
> ```
